...
const WikiComponent =() => {
  ...
  const fetchWikipediaData = async () => {
    const url =
      'https://en.wikipedia.org/w/api.php?action=query&origin=*&format=json&generator=search&gsrnamespace=0&gsrlimit=5&gsrsearch=Buffalo%Bills';
  ...
  return (
    <div style ={{ backgroundColor: 'white'}}>
      <h2 style={{ color: 'maroon' }}>Wikipedia Search Results for "Buffalo Bills"</h2>
